		...
		for(int i = 0; i < userCommands.length; i++)
		{
			...
			switch(userCommands[i])
			{
				...
				case "gdeleteuser":
					...
					break;
				// TODO: Check the user's user token when creating or deleting a group
				// GroupClient update: Will pass back null or userToken. If null,
			    // deleteion of creation was unsuccesful.
				case "gcreategroup":
					i++;
				...
				case "glistmembers":
					...
					// TODO: Finish the file server commands
